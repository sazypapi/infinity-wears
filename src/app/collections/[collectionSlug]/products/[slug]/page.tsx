import {
  getProductRatings,
  getProductReviews,
  getSingleProductDetailsForCollectionsPage,
  getYouMayAlsoLike,
} from "../../../../../../utils/actions";
...
async function ProductDetailsPage({
  ...
  const productDetails = await getSingleProductDetailsForCollectionsPage(slug);
        ...
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink
              ...
              href={`/collections/${productDetails.collection?.slug}`}>
