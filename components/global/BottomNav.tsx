...
function BottomNav({ isAdmin }: { isAdmin: boolean }) {
  return (
    <div className="flex justify-center w-full items-center z-999 pointer-events-auto">
      <div className="fixed bottom-0 w-[90%] sm:w-[50%] px-5 py-4 h-15 flex justify-between items-center bg-black/30 backdrop-blur-md backdrop-saturate-150 shadow-lg text-white rounded-4xl">
        <Link href="/shop">
