...
import { editCustomOrder } from "../../utils/actions";
  ...
  return (
    <>
      <Dialog>
        ...
        >
          <FormContainer action={editCustomOrder}>
            ...
            <DialogHeader className="my-5">
              ...
              <FormInput
                ...
                required
                defaultValue={orderRequest.customOrder?.agreedPrice.toString()}
                className="text-white placeholder:text-neutral-200"
              />
              <Select
                defaultValue={orderRequest.customOrder?.status}
                name="status"
              >
