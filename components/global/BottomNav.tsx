...
function BottomNav({ isAdmin }: { isAdmin: boolean }) {
  return (
    <div className="flex justify-center w-full items-center z-50">
      <div className="fixed bottom-[2vh] w-[90%] sm:w-[50%] px-5 py-4 h-15 flex justify-between items-center bg-black/30 backdrop-blur-md backdrop-saturate-150 shadow-lg text-white rounded-4xl">
        <Link href="/shop">
